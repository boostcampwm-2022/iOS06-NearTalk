...
struct ChatRoomDummyData {
    ...
    init() {
        chatRoomData.append(ChatRoom(roomID: "1", userList: ["s001", "s002", "s003", "s004", "s005"], roomType: "group", roomName: "네이버", roomDescription: "술기운이 올라오니"))
        chatRoomData.append(ChatRoom(roomID: "2", userList: ["s001", "s002", "s003", "s005"], roomType: "group", roomName: "다음", roomDescription: "사내놈들끼린 결국엔 여자 얘기"))
        chatRoomData.append(ChatRoom(roomID: "3", userList: ["s001", "s002", "s003", "s004", "s005"], roomType: "group", roomName: "카카오", roomDescription: "적적해서 서로의 전화기를 꺼내"))
        chatRoomData.append(ChatRoom(roomID: "4", userList: ["s001", "s004", "s005"], roomType: "group", roomName: "넷마블", roomDescription: "번호목록을 뒤져보지"))
        chatRoomData.append(ChatRoom(roomID: "5", userList: ["s001", "s002", "s003", "s004", "s005", "s011", "s013", "s014", "s015"], roomType: "group", roomName: "넥슨", roomDescription: "너는 지금 뭐해 자니 밖이야?"))
        chatRoomData.append(ChatRoom(roomID: "6", userList: ["s001", "s009", "s007", "s014", "s021"], roomType: "group", roomName: "엔씨", roomDescription: "뜬금없는 문자를 돌려보지 난"))
        chatRoomData.append(ChatRoom(roomID: "7", userList: ["s001", "s017"], roomType: "group", roomName: "구글", roomDescription: "어떻게 해볼까란 뜻은 아니야"))
        chatRoomData.append(ChatRoom(roomID: "7", userList: ["s001", "s017", "s022"], roomType: "group", roomName: "아마존", roomDescription: "그냥 심심해서 그래 아니 외로워서 그래"))
