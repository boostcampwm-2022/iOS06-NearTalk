...
//  NearTalk
//
//  Created by lymchgmk on 2022/12/11.
//

import UIKit

extension UIFont {
    static let ntTextLargeRegular: UIFont = .systemFont(ofSize: 20, weight: .regular)
    static let ntTextMediumRegular: UIFont = .systemFont(ofSize: 16, weight: .regular)
